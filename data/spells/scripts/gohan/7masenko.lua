...
local effect = {
    [0] = {look=266, x=1, y=-1, z=0, combat=combat0},
    [1] = {look=268, x=5, y=1, z=0, combat=combat1},
    [2] = {look=267, x=1, y=5, z=0, combat=combat2},
    [3] = {look=265, x=-1, y=1, z=0, combat=combat3}
}
...
function onCastSpell(creature, var)
    ...
    addEvent(masenko1,2000,creature.uid, var)
return true
end
