...
local effect = {
    ...
    [1] = {look=238, x=5, y=1, z=0, combat=combat1},
    [2] = {look=241, x=1, y=5, z=0, combat=combat2},
    [3] = {look=239, x=-1, y=1, z=0, combat=combat3}
}
...
function finalshineattack1(cid, variant)
...
function onCastSpell(creature, var)
    ...
    addEvent(finalshineattack1,3000,creature.uid, var)
return true
end
